...
public class BackGround {
	...
	{           
	    ...
	    else if (xy1.y == xy2.y)  //line horizontal
	    {
	        while (x != xy2.x)
	        {
	    ...
	    else if (xy1.x != xy2.x && xy1.y != xy2.y)// line vertical
	    {
...
class PopMenuEdge{
	...
	public void Show(Graphics2D g,int x,int y){
		...
		g.drawString("Delete this node", x+3, y+20);
		
		g.setColor(Color.blue);
		g.drawString("»‘", x+3, y+50);
